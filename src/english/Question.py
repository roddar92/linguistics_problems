...
if __name__ == "__main__":
    ...
    assert q.request("I FILL* WELL") == "DO I FILL WELL?"
    ...
    assert q.request("I USUALLY PULL* CHANGES FROM REPOSITORY") == "DO I USUALLY PULL CHANGES FROM REPOSITORY?"
    ...
    assert q.request("LIZ MET* HER DAD IN THE AIRPORT YESTERDAY") == "DID LIZ MEET HER DAD IN THE AIRPORT YESTERDAY?"
